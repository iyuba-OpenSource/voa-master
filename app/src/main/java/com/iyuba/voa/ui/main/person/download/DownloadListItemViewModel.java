 ...
 * @description
 */
public class DownloadListItemViewModel extends ItemViewModel<DownloadListViewModel> {
...
//        bundle.putString(Constants.BUNDLE.KEY_1, entity.get().getSound());
    ...
    public DownloadListItemViewModel(@NonNull DownloadListViewModel viewModel, TitleTed data) {
        super(viewModel);
        entity.set(data);
    }
