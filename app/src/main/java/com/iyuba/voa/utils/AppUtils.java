...
public class AppUtils {
    ...
    public static void getFlavorInfo() {
        try {
...
//                        AppConfig.CHANNEL = channel;
                        ToastUtils.showShort("当前的渠道为:" + channel);
                        XLog.i("Channel", "当前的渠道为:" + channel);
                    }
                }
            }
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
            XLog.e("Channel", e.getMessage() + "");
        }
    }
    ...
    public static String getChannel() {
        try {
            ...
            ApplicationInfo appInfo = pm.getApplicationInfo(Utils.getContext().getPackageName(), PackageManager.GET_META_DATA);
